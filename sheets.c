...
/*
                ...
                //if (J_cs[i][j][k] > J_FAC*J_mean[i]) {
                if ((J_cs[i][j][k] > J_FAC*J_mean[i]) && (betapl[i][j][k] > BETAPL_THR)) {
                //if ((J_cs[i][j][k] > J_FAC*J_mean[i]) && (sigmaphi[i][j][k] < SIGMAPHI_THR)) {
                //if ((J_cs[i][j][k] > J_FAC*J_mean[i]) && (Sigmaphi[i][j][k] < SIGMAPHI_THR)) {
                //aux = bu3[i][j][k];
                //if ((J_cs[i][j][k] > J_FAC*J_mean[i]) && (BETWEEN(aux, -BU3_THR, BU3_THR))) {
