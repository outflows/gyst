...
void get_current_sheets()
{
    ...
    // Loop over all J_cs points. For each point, look within a 7x7x7 box
    // surrounding it. If any point inside this box has a larger current,
    // then the initial point is not a local maximum and is excluded from
    // the sample.
    get_locmax();
